...
def render_survey_index_page() -> str:
    lines = [
        ...
        '<a href="surveys.md"><img src="../assets/survey-resource-icons/surveys.png" width="46" height="46" alt=""><br><strong>Surveys</strong></a>',
        "</td>",
        '<td width="50%" align="center" valign="middle">',
        '<a href="perspectives.md"><img src="../assets/survey-resource-icons/perspectives.png" width="46" height="46" alt=""><br><strong>Perspectives</strong></a>',
        "</td>",
        "</tr>",
        "</table>",
        "",
